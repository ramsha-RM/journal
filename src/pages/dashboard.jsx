...
useEffect(() => {
  const storedUserName = localStorage.setItem('username');
  if(storedUserName) 
    ...
    <main className="main">
      ...
      <div className="moods-time">
        <div className="feelings">
         {moods.map((mood) => {
          ...
          {/* <button className="moods happy">
            <span className="emoji">😄</span>
            <span className="label">Happy</span>
          </button>

          <button className="moods sad">
            <span className="emoji">😔</span>
            <span className="label">Sad</span>
          </button>

          <button className="moods angry">
            <span className="emoji">😤</span>
            <span className="label">Angry</span>
          </button>

          <button className="moods tired">
            <span className="emoji">😴</span>
      ...
      <div className="bottom">
        ...
        <div className="actions">
          <button onSubmit={handleSubmit} className="newEntryBtn">Add Entry</button>
          <button onSubmit={handleClear} className="clear">Clear</button>
        </div>
      </div>
    </main>
    </div>
